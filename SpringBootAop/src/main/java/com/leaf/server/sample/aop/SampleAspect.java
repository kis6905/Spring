package com.leaf.server.sample.aop;
...
public class SampleAspect {
	...
	@Before("execution(* com.leaf.server.*.controller.*.*(..))")
	public void beforeController(JoinPoint joinPoint) {
		...
		log.info("=============================================");
		log.info("== Request {}.{}()", signature.getDeclaringTypeName(), method.getName());
	...
	@Before("execution(* com.leaf.server.*.service.*.*(..))")
	public void beforeService(JoinPoint joinPoint) {
		log.info("-> [========= beforeService]");
